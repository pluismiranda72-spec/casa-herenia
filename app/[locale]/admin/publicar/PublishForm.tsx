...
export default function PublishForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto">
      ...
      <div>
        <span className="font-sans text-sm text-[#C5A059] mb-2 block">Foto o vídeo (arrastrar o clic)</span>
        <div
          {...getRootProps()}
        ...
        >
          ...
          <p className="font-sans text-sm text-white/80">
            {isDragActive ? "Suelta aquí..." : "Arrastra un archivo o haz clic. Imágenes comprimidas; vídeos máx. 10MB (mp4/webm)."}
          </p>
        </div>
        {preview && (
