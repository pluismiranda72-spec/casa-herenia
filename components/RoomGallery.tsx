      ...
      <Link
        ...
        <div className="flex justify-center mt-8 mb-12 w-full">
          <Link
            ...
            className="group inline-flex items-center gap-2 px-6 py-2.5 bg-emerald-600 text-white font-semibold rounded-full text-sm transition-all duration-300 ease-in-out hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
          >
            <svg
